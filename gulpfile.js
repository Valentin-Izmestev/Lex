...
let path = {
    ...
    build:{
        html: project_folder +"/",
        css: project_folder + "/local/templates/lex/css/",
        js: project_folder +"/local/templates/lex/js/",
        img: project_folder +"/local/templates/lex/img/",
        image: project_folder +"/local/templates/lex/image/",
        fonts: project_folder +"/local/templates/lex/fonts/"
    },
    //исходники
    src:{ 
        html: [source_folder +"/*.html", "!" + source_folder +"/_*.html"],
        scss: source_folder +"/local/templates/lex/scss/style.scss",
    ...
    watch:{
        ...
        scss: source_folder +"/local/templates/lex/scss/**/*.scss",
        js: source_folder +"/local/templates/lex/js/**/*.js",
        img: source_folder +"/local/templates/lex/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/local/templates/lex/image/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/local/templates/lex/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
...
gulp.task('svgSprite', function(){ 
    return gulp.src('src/local/templates/lex/img/for-svg-icon/*.svg')
        .pipe(svgSprite({
            mode:{
                stack:{
        ...
        .pipe(dest('src/local/templates/lex/img/'))
});
